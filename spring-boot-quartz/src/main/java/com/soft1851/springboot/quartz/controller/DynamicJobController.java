...
public class DynamicJobController {
    ...
    public String refresh(@PathVariable Integer id) throws SchedulerException {
        ...
        synchronized (log) {
            ...
            JobDetail jobDetail = dynamicJobService.getJobDetail(DynamicJob.class,jobKey, entity.getDescription(), map);
    ...
    private void reStartAllJobs() throws SchedulerException {
        ...
        synchronized (log) {
            ...
            for (JobEntity job : dynamicJobService.loadJobs()) {
                ...
                JobDetail jobDetail = dynamicJobService.getJobDetail(DynamicJob.class,jobKey, job.getDescription(), map);
